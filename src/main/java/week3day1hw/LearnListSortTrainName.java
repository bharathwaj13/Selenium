...
public class LearnListSortTrainName {
...
//		System.out.println(driver.findElementByXPath("//table[@class='DataTable TrainList']/tbody/tr[2]/td/a").getText());
		...
		{
//			System.out.println(driver.findElementByXPath("//table[@class='DataTable TrainList']/tbody/tr["+i+"+1]/td[2]/a").getText());
			trainNames.add(driver.findElementByXPath("//table[@class='DataTable TrainList']/tbody/tr["+i+"+1]/td[2]/a").getText());
		}
		...
		{
			System.out.println(driver.findElementByXPath("//table[@class='DataTable TrainList']/tbody/tr["+i+"+1]/td[2]/a").getText());
			sortedTrainNames.add(driver.findElementByXPath("//table[@class='DataTable TrainList']/tbody/tr["+i+"+1]/td[2]/a").getText());
		}
		boolean flag=true;
		for(int i=0;i<rowCount;i++)
		{
			if(!trainNames.get(i).equals(sortedTrainNames.get(i)))
				flag=false;
			break;
		}
		if(flag)
